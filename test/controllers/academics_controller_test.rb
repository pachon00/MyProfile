...
class AcademicsControllerTest < ActionController::TestCase
  ...
  test "should create academic" do
    assert_difference('Academic.count') do
      post :create, academic: { end_date: @academic.end_date, grade: @academic.grade, location: @academic.location, name: @academic.name, start_date: @academic.start_date }
    end
  ...
  test "should update academic" do
    patch :update, id: @academic, academic: { end_date: @academic.end_date, grade: @academic.grade, location: @academic.location, name: @academic.name, start_date: @academic.start_date }
    assert_redirected_to academic_path(assigns(:academic))
  end
