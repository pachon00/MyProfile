...
class TrainingsControllerTest < ActionController::TestCase
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post :create, training: { end_date: @training.end_date, level: @training.level, name: @training.name, porcent: @training.porcent, start_date: @training.start_date }
    end
  ...
  test "should update training" do
    patch :update, id: @training, training: { end_date: @training.end_date, level: @training.level, name: @training.name, porcent: @training.porcent, start_date: @training.start_date }
    assert_redirected_to training_path(assigns(:training))
  end
